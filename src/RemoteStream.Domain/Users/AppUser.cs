...
namespace RemoteStream.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update RemoteStreamDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update RemoteStreamEfCoreEntityExtensionMappings to extend the IdentityUser entity
