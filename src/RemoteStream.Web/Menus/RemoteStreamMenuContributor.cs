...
namespace RemoteStream.Web.Menus
{
    public class RemoteStreamMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public RemoteStreamMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<RemoteStreamResource>();

            context.Menu.Items.Insert(0, new ApplicationMenuItem("RemoteStream.Home", l["Menu:Home"], "~/"));
